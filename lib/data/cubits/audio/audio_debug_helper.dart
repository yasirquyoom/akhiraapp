...
class AudioDebugHelper {
  static Future<void> testAudioPlayback() async {
    print('=== AUDIO PLAYBACK DEBUG TEST ===');

    final audioPlayer = AudioPlayer();

    try {
      // Test 1: Check if audio player is working with a simple URL
      print('Test 1: Testing with simple audio URL...');
      const testUrl =
      ...
      print('Test 1 SUCCESS: Simple URL played');
    ...
    try {
      ...
      print('Test 2: Testing Supabase URL accessibility...');
      ...
      print('Test 2 FAILED: Supabase URL not accessible - $e');
    }
    ...
    try {
      const supabaseUrl =
          'https://qkdeafwgtpqsglxyxycd.supabase.co/storage/v1/object/public/ebook-files/books/6ce220fc-7569-4f67-99bc-9c5617af0c1a/content/83d87a8e-7fdb-41f0-8bb8-0695aa8426f9.wav?';
      print('Test 3: Testing Supabase URL playback...');
      ...
      print('Test 3 SUCCESS: Supabase URL played');
      await audioPlayer.stop();
    } catch (e) {
      print('Test 3 FAILED: Supabase URL playback failed - $e');
    }

    await audioPlayer.dispose();
    print('=== END AUDIO PLAYBACK DEBUG TEST ===');
  }
}
